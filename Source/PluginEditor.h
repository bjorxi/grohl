...
private:
  ...
  GrohlRotarySlider attack{" ms", 0.0f, 100.0, 1};
  GrohlRotarySlider ratio{":1", 1.0f, 8.0f, 1.0f};
  GrohlRotarySlider treshold{" Db", -24.0f, 12.0f, 0.1f};
  GrohlRotarySlider release{" ms", 0.0f, 100.0, 1};
